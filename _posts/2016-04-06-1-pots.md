...
<div style="background: url('/assets/posts/mudpots-1.jpg') no-repeat; background-size: cover; width:100%; height:0px; margin-top:0px; margin-bottom:25px; padding-top:320px; margin-left:auto; margin-right:auto;"></div>
...
<div style="background: url('/assets/posts/mudpots-2.jpg') no-repeat; background-size: cover; width:415px; height:300px; display:inline; float:left; margin:20px;"></div>
...
<div style="background: url('http://www.theworldaccordingtosound.org/assets/posts/saminterviewingmudpot.jpg') no-repeat; background-size: cover; width:210px; height:300px; display:inline; float:right; margin:20px; margin-bottom:35px;"></div>
...
Photo Credit: <a href="http://www.vigfusson.com/">Gundi Vigfusson</a>
