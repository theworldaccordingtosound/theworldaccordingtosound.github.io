...
<div style="background: url('https://upload.wikimedia.org/wikipedia/commons/7/70/Bubbling_mud_with_bubble_starting_to_burst_%28Hell%27s_Gate_thermal_area%29.jpg') no-repeat; background-size: cover; width:500px; height:250px; border:4px solid #fff; border-bottom:30px solid #fff; margin-bottom:20px; margin-left:auto; margin-right:auto;"><div style="margin-top:250px; font-size:60%;">Mud pots are only found in a few places around the country.</div></div>
