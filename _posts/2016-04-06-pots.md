...
<div style="background: url('http://www.theworldaccordingtosound.org/assets/posts/saminterviewingmudpot.jpg') no-repeat; background-size: cover; width:300px; height:250px; display:inline; float:left; border:4px solid #fff; border-bottom:30px solid #fff; margin:20px;"></div>
