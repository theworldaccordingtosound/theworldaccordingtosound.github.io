...
<div style="background: url('http://www.theworldaccordingtosound.org/assets/posts/saminterviewingmudpot.jpg') no-repeat; background-size: cover; width:210px; height:300px; display:inline; float:right; margin:20px;"><div style="margin-top:310px; font-size:60%;">Sam interviews a mud pot. Photo: <a href="http://www.vigfusson.com/">Gundi Vigfusson</a>.</div></div>
