...
<div style="background: url('https://upload.wikimedia.org/wikipedia/commons/7/70/Bubbling_mud_with_bubble_starting_to_burst_%28Hell%27s_Gate_thermal_area%29.jpg') no-repeat; background-size: cover; width:500px; height:0px; margin-top:0px; margin-bottom:50px; padding-top:250px; margin-left:auto; margin-right:auto;"><div style="margin-top:8px; font-size:60%;">Mud pots are only found in a few places around the country.</div></div>
...
<div style="background: url('http://www.theworldaccordingtosound.org/assets/posts/saminterviewingmudpot.jpg') no-repeat; background-size: cover; width:210px; height:300px; display:inline; float:right; margin:20px; margin-bottom:35px;"><div style="margin-top:310px; font-size:60%;">Sam interviews a mud pot. Photo: <a href="http://www.vigfusson.com/">Gundi Vigfusson</a>.</div></div>
